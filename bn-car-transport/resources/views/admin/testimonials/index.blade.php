                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $testimonials->total() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $testimonials->where('is_approved', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $testimonials->where('is_approved', false)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $testimonials->where('is_featured', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-4 flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600 mt-1">{{ Str::limit($testimonial->message, 100) }}</p>
                                    
                                    <div class="flex items-center mt-2 text-xs text-gray-500">
                                        @if($testimonial->location)
                                            <span class="mr-3">📍 {{ $testimonial->location }}</span>
                                        @endif
                                        @if($testimonial->service_used)
                                            <span class="mr-3">🚗 {{ $testimonial->service_used }}</span>
                                        @endif
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <form action="{{ route('admin.testimonials.approve', $testimonial) }}" method="POST" class="inline">
                                    ...
                                    @method('PATCH')
                                    <button type="submit" 
                                            class="text-{{ $testimonial->is_approved ? 'yellow' : 'green' }}-400 hover:text-{{ $testimonial->is_approved ? 'yellow' : 'green' }}-600" 
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by adding your first customer testimonial.</p>
                    <div class="mt-6">
                        <a href="{{ route('admin.testimonials.create') }}" 
